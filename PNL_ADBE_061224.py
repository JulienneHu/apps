...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.trade_date_input = create_input_field("Trade Date", '2024-06-12', control_layout)
        self.symbol_input = create_input_field("Symbol", 'ADBE', control_layout)
        self.strike_input = create_input_field("Strike Price", '470', control_layout)
        ...
        self.call_trade_price_input = create_input_field("Call Trade Price", '22.84', control_layout)
