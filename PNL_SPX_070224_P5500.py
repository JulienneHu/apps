...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.strike_input = create_input_field("Strike Price", '5500', control_layout)
        ...
        self.num_put_contracts_input = create_input_field("NPut Contracts", '3', control_layout)
        
        self.call_trade_price_input = create_input_field("Call Trade Price", '0.00', control_layout)
        self.put_trade_price_input = create_input_field("Put Trade Price", '71.80', control_layout)
