...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.strike_input = create_input_field("Strike Price", '235', control_layout)
        ...
        self.num_call_contracts_input = create_input_field("NCall Contracts", '5', control_layout)
        self.num_put_contracts_input = create_input_field("NPut Contracts", '5', control_layout)
        
        self.call_trade_price_input = create_input_field("Call Trade Price", '15.90', control_layout)
        self.put_trade_price_input = create_input_field("Put Trade Price", '21.61', control_layout)
