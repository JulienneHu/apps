...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.symbol_input = create_input_field("Symbol", 'PANW', control_layout)
        self.strike_input = create_input_field("Strike Price", '320', control_layout)
        self.expiration_input = create_input_field("Expiration Date", '2024-08-16', control_layout)
        self.stock_trade_price_input = create_input_field("Stock Trade Price", '0.0', control_layout)
        ...
        self.num_put_contracts_input = create_input_field("NPut Contracts", '2', control_layout)
        
        self.call_trade_price_input = create_input_field("Call Trade Price", '0.00', control_layout)
        self.put_trade_price_input = create_input_field("Put Trade Price", '7.40', control_layout)
