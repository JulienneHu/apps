...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.symbol_input = create_input_field("Symbol", 'GS', control_layout)
        self.strike_input = create_input_field("Strike Price", '510', control_layout)
        ...
        self.put_trade_price_input = create_input_field("Put Trade Price", '13.88', control_layout)
