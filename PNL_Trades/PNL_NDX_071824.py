...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        self.setWindowTitle("Index Option PNL Tracker")
        ...
        self.symbol_input = create_input_field('Symbol', '^NDX', control_layout)
        self.option_chain_input = create_input_field('Option Chain', 'NDX', control_layout, False)
        self.strike_input = create_input_field("Strike Price", '19600', control_layout)
        ...
        self.call_trade_price_input = create_input_field("Call Trade Price", '483.57', control_layout)
        self.put_trade_price_input = create_input_field("Put Trade Price", '379.47', control_layout)
