...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.trade_date_input = create_input_field("Trade Date", '2024-07-15', control_layout)
        self.symbol_input = create_input_field("Symbol", 'JPM', control_layout)
        self.strike_input = create_input_field("Strike Price", '210', control_layout)
        ...
        self.call_trade_price_input = create_input_field("Call Trade Price", '4.95', control_layout)
        self.put_trade_price_input = create_input_field("Put Trade Price", '4.05', control_layout)
