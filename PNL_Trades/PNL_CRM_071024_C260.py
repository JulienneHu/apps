...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.strike_input = create_input_field("Strike Price", '260', control_layout)
        ...
        self.call_trade_price_input = create_input_field("Call Trade Price", '5.70', control_layout)
