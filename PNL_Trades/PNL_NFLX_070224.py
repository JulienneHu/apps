...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.symbol_input = create_input_field("Symbol", 'NFLX', control_layout)
        self.strike_input = create_input_field("Strike Price", '680', control_layout)
        self.expiration_input = create_input_field("Expiration Date", '2024-08-16', control_layout)
        self.stock_trade_price_input = create_input_field("Stock Trade Price", '675.95', control_layout)
        self.effective_delta_input = create_input_field("Effective Delta", '0.00', control_layout)
        ...
        self.num_put_contracts_input = create_input_field("NPut Contracts", '5', control_layout)
        
        self.call_trade_price_input = create_input_field("Call Trade Price", '0.00', control_layout)
        self.put_trade_price_input = create_input_field("Put Trade Price", '36.84', control_layout)
