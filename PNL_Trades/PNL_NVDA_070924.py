...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.symbol_input = create_input_field("Symbol", 'NVDA', control_layout)
        self.strike_input = create_input_field("Strike Price", '140', control_layout)
        ...
        self.put_trade_price_input = create_input_field("Put Trade Price", '12.20', control_layout)
