...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.call_trade_price_input = create_input_field("Call Trade Price", '17.36', control_layout)
        self.put_trade_price_input = create_input_field("Put Trade Price", '28.41', control_layout)
