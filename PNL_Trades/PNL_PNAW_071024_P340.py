...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.strike_input = create_input_field("Strike Price", '340', control_layout)
        ...
        self.put_trade_price_input = create_input_field("Put Trade Price", '17.98', control_layout)
