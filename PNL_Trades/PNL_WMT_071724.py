...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.symbol_input = create_input_field("Symbol", 'WMT', control_layout)
        self.strike_input = create_input_field("Strike Price", '72.5', control_layout)
        ...
        self.call_trade_price_input = create_input_field("Call Trade Price", '1.19', control_layout)
