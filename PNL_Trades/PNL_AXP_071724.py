...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.trade_date_input = create_input_field("Trade Date", '2024-07-17', control_layout)
        self.symbol_input = create_input_field("Symbol", 'AXP', control_layout)
        ...
        self.num_call_contracts_input = create_input_field("NCall Contracts", '10', control_layout)
        self.num_put_contracts_input = create_input_field("NPut Contracts", '10', control_layout)
        
        self.call_trade_price_input = create_input_field("Call Trade Price", '8.20', control_layout)
        self.put_trade_price_input = create_input_field("Put Trade Price", '7.55', control_layout)
