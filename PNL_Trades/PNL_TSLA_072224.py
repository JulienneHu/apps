...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.trade_date_input = create_input_field("Trade Date", '2024-07-22', control_layout)
        self.symbol_input = create_input_field("Symbol", 'TSLA', control_layout)
        self.strike_input = create_input_field("Strike Price", '250', control_layout)
        ...
        self.call_action_type_input = create_combo_box("Call Action Type", ["sell"], control_layout)
        self.put_action_type_input = create_combo_box("Put Action Type", ["sell"], control_layout)
        
        self.num_call_contracts_input = create_input_field("NCall Contracts", '4', control_layout)
        self.num_put_contracts_input = create_input_field("NPut Contracts", '4', control_layout)
        
        self.call_trade_price_input = create_input_field("Call Trade Price", '15.54', control_layout)
        self.put_trade_price_input = create_input_field("Put Trade Price", '17.95', control_layout)
