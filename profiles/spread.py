...
class OptionStrategyVisualizer(QMainWindow):
    ...
    def initUI(self):
        ...
        # Sliders
        self.num1_slider = self.create_slider('N1', 0, 5, 1, 1) 
        control_layout.addWidget(self.num1_slider)

        self.num2_slider = self.create_slider('N2', 0, 5, 1, 1)
        ...
        self.stock_price_input = self.create_input_field('SPrice', '150', editable=False)
