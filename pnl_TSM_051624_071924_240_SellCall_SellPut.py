...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.trade_date_input = create_input_field("Trade Date", '2024-05-16', control_layout)
        self.symbol_input = create_input_field("Symbol", 'TSM', control_layout)
        self.strike_input = create_input_field("Strike Price", '160', control_layout)
        self.expiration_input = create_input_field("Expiration Date", '2024-07-19', control_layout)
        self.stock_trade_price_input = create_input_field("Stock Trade Price", '152.23', control_layout)
        ...
        self.call_trade_price_input = create_input_field("Call Trade Price", '6.72', control_layout)
        self.put_trade_price_input = create_input_field("Put Trade Price", '11.04', control_layout)
