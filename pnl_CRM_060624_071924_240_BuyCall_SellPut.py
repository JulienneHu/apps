...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.trade_date_input = create_input_field("Trade Date", '2024-06-06', control_layout, False)
        self.symbol_input = create_input_field("Symbol", 'CRM', control_layout, False)
        self.strike_input = create_input_field("Strike Price", '240', control_layout, False)
        self.expiration_input = create_input_field("Expiration Date", '2024-07-19', control_layout, False)
        self.stock_trade_price_input = create_input_field("Stock Trade Price", '242.53', control_layout, False)
        self.effective_delta_input = create_input_field("Effective Delta", '0', control_layout, False)
        ...
        self.num_call_contracts_input = create_input_field("NCall Contracts", '1', control_layout, False)
        self.num_put_contracts_input = create_input_field("NPut Contracts", '1', control_layout, False)
        
        self.call_trade_price_input = create_input_field("Call Trade Price", '10.09', control_layout, False)
        self.put_trade_price_input = create_input_field("Put Trade Price", '5.99', control_layout, False)
