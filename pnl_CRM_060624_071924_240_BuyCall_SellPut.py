...
class OptionPNLApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.trade_date_input = create_input_field("Trade Date", '2024-06-06', control_layout)
        self.symbol_input = create_input_field("Symbol", 'CRM', control_layout)
        self.strike_input = create_input_field("Strike Price", '240', control_layout)
        self.expiration_input = create_input_field("Expiration Date", '2024-07-19', control_layout)
        self.stock_trade_price_input = create_input_field("Stock Trade Price", '242.53', control_layout)
        ...
        self.call_trade_price_input = create_input_field("Call Trade Price", '10.09', control_layout)
        self.put_trade_price_input = create_input_field("Put Trade Price", '5.99', control_layout)
